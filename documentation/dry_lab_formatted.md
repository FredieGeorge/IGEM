...
[RL-HCl.pdf](Documents/IGEM/documentation/files/RL-HCL.pdf)
...
[Covid vaccines by Pfizer and Moderna.pdf](</files/Dry Lab/Covid vaccines by Pfizer and Moderna.pdf>)
...
[Novel drug targets with traditional herbal medicines for overcoming Endometriosis.pdf](</files/Dry Lab/Novel drug targets with traditional herbal medicines for overcoming Endometriosis.pdf>)
...
[mRNA-LNP delivery systems.pdf](</files/Dry Lab/Research Papers/mRNA-LNP delivery systems.pdf)[LNP delivery-intraperitoneal administration.pdf] (</files/Dry Lab/Research Papers/LNP delivery-intraperitoneal administration.pdf>)
...
[Interleukin-8_concentration_in_peritoneal_fluid_of.pdf](</files/Dry Lab/Interleukin-8_concentration_in_peritoneal_fluid_of.pdf>)[1-s2.0-S0015028216575062-main.pdf](</files/Dry Lab/1-s2.0-S0015028216575062-main.pdf>)
...
[O-IL8-15 sequence word.docx](</files/Dry Lab/O-IL8-15 sequence word.docx)>[GS-mK-100A-BspQI-GOI (1) (1).dna>](</files/Dry Lab/GS-mK-100A-BspQI-GOI (1) (1).dna>)
...
[DryLab5, 21062023.md](</minutes/DryLab5, 21062023.md>)
...
[Homework.docx](</files/Dry Lab/mRNA-LNP Delivery Systems/Homework.docx>)
...
[Peripheral biomarkers for endometriosis.pdf](</files/Dry Lab/Peripheral biomarkers for endometriosis.pdf>)
...
[6/28, 4:01 PM] **Aditya Kamath Ammembal**
    Dry Lab Sorry I forgot to mention, but I've located a Surface Plasmon Resonance facility in the MBU, and we'll probably be able to access it, so we'll have good affinity data when we purify the antibody. 
		...
		[6/28, 4:11 PM] **Aditya Kamath Ammembal**
...
[DryLabUpdates.pdf](</files/Dry Lab/mRNA-LNP Delivery Systems/DryLabUpdates.pdf>)
...
I’m also reading the ORF paper you’ve put up. (ORF is basically just a sequence of codons to be read by the ribosome, it’s explained well here) 
		...
		[mrnaeff.pdf] (</files/Dry Lab/mRNA-LNP Delivery Systems/mrnaeff.pdf)
...
[PK and PD of LNPS.docx](</files/Dry Lab/PK and PD of LNPS.docx>)
...
[Reasons for targetting IL-8 .docx](</files/Dry Lab/Reasons for targetting IL-8 .docx>)
...
[7/14, 2:25 AM] **Mrigank Pawagi**Docking of scFv with IL8 is complete!
...
[Relating il-8 levels with active lesion score.docx](</files/Dry Lab/Relating il-8 levels with active lesion score.docx>)
...
[lnp formulation prediction.pdf](</files/Dry Lab/lnp formulation prediction.pdf>)	
...
[WIKI SEARCH.odt](</files/Dry Lab/WIKI SEARCH.odt>)
...
[8/6, 7:10 PM] **Mrigank Pawagi**For PK
...
[incancer.pdf](</files/Dry Lab/PKPDMathModels/incancer.pdf>)[eprnanomeds.pdf](</files/Dry Lab/PKPDMathModels/eprnanomeds.pdf>)
...
[PK Sim.docx](</files/Dry Lab/PK Sim.docx>)
...
[Endometriosis and Basal Body Temperature.docx](</files/Dry Lab/Endometriosis and Basal Body Temperature.docx>)